...
<div class="wrapper">
    	...
    	<div class="sidebar-wrapper">
            <div class="logo">
             ...
             <ul class="nav">
                ...
                <li class="active">
                    <a href="itgestionservicio.php">
                        <i class="pe-7s-user"></i>
                        <p>Solicitud de Servicio </p>
                    </a>
                </li>
                <li>
                    <a href="casoscerradosmod.php">
    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
				...
				<button type='button' class="btn btn-info" data-toggle="modal" data-target="#nuevoCliente"><span class="glyphicon glyphicon-plus" ></span> Crear Solicitud de Servicio </button>                 
			</div>
                                <h4 class="title">Gesti&oacute;n de Servicio</h4>
                                <p class="category">Lista de Actividades</p>
                            ...
                            <div class="content table-responsive table-full-width">
                                 ...
                                 <h4 class="title">Prioridad Inmediata</h4>
                  ...
                  <?php
                    ...
                    $res=mysql_query("select * from actividades where ESTADO_ACTIVIDAD='0' AND PRIORIDAD_ACTIVIDAD='Inmediata' order by `FECHA_INGRESO` asc  ");
 ...
 <tbody>
                   <tr>
                       ...
                       <td><span><?php echo $fila["NOM_ACTIVIDAD"]; ?></span></td>
                        <td><span><?php echo $fila["DESCRIP_ACTIVIDAD"]; ?></span></td>
                        <td><span><?php echo $fila["AREA_ACTIVIDAD"]; ?></span></td>
                        <td><span><?php echo $fila["PRIORIDAD_ACTIVIDAD"]; ?></span></td>
                         <td align="center"> 
                           
				<form id="form" name="form" method="post" action="lib/ingresoasignacion.php">
                                                            
                                    <input type="hidden" name="id" id='id' value="<?php echo $fila["ID_ACTIVIDAD"]; ?>">
                                  
                                    <select style='width:170px; height:40px' class="form-control" id="persona" name="persona" required>
					<option value="">-- Selecciona persona --</option>
					<option value="Fabricio Maldonado" selected>Fabricio Maldonado</option>
					<option value="Ivan Lema">Ivan Lema</option>
                                        <option value="Departamento Sistemas">Departamento Sistemas</option>
                                     </select>
                                    
                                    <input type="submit" class="btn btn-success" style='width:170px; height:40px' name="btnAceptar" id="btnAceptar" value="Aceptar" />
                                </form>
                       ...
                       <td align="center"> 
                           ...
                           <form id="form" name="form" method="post" action="lib/ingresoestado.php">
                               
                                <input type="hidden" name="id" id='id' value="<?php echo $fila["ID_ACTIVIDAD"]; ?>">
                                
                                    <select id="estado" class="form-control" name="estado" style='width:100px; height:40px' required>
					...
					<option value="Pausado">Pausado</option>
                                ...
                                <input  type="submit" class="btn btn-success" style='width:100px; height:40px' name="btnAceptar" id="btnAceptar" value="Aceptar" />
                            </form>
				
                        </td>  
 
                        <td><span><?php echo $fila["FECHA_INGRESO"]; ?></span></td>  
                        <td><span><?php echo $fila["FECHA_INICIO"]; ?></span></td>  
                        <td><span><?php echo $fila["FECHA_FINALIZACION"]; ?></span></td>
                        <td><span><?php echo $fila["USUARIO"]; ?></span></td>                        
 ...
 <tbody>
                   <tr>
                       ...
                       <td><span><?php echo $fila["NOM_ACTIVIDAD"]; ?></span></td>
                        ...
                        <td><span><?php echo $fila["AREA_ACTIVIDAD"]; ?></span></td>
                        <td><span><?php echo $fila["PRIORIDAD_ACTIVIDAD"]; ?></span></td>
                        <td><span><?php echo $fila["PERSONA_DESIGNADA"]; ?></span></td>
                        <td><span><?php echo $fila["ESTADO"]; ?></span></td>     
                        <td><span><?php echo $fila["FECHA_INGRESO"]; ?></span></td>  
                        <td><span><?php echo $fila["FECHA_INICIO"]; ?></span></td>  
                        <td><span><?php echo $fila["FECHA_FINALIZACION"]; ?></span></td>
                        <td><span><?php echo $fila["USUARIO"]; ?></span></td>      
                        <td><a href="lib/cambiodecaso.php?id=<?php echo $fila['ID_ACTIVIDAD'];?>" type="button" class="btn btn-danger">Cerrar Actividad</a></td>     
                   </tr>
                   ...
                   <?php } ?>
                                 ...
                                 <h4 class="title">Prioridad Alta</h4>
                                                             <table class="table table-hover table-striped">
                                    <thead>
                                        <th>Id</th>
                                         <th>Nombre Actividad</th>       
                  ...
                  <?php
                    ...
                    $res=mysql_query("select * from actividades where ESTADO_ACTIVIDAD='0' AND PRIORIDAD_ACTIVIDAD='Alta' order by `FECHA_INGRESO` asc  ");
 ...
 <tbody>
                   ...
                   <?php } ?>
                                 ...
                                 <h4 class="title">Prioridad Media</h4>
                  ...
                  <?php
                    ...
                    $res=mysql_query("select * from actividades where ESTADO_ACTIVIDAD='0' AND PRIORIDAD_ACTIVIDAD='Media' order by `FECHA_INGRESO` asc  ");
 ...
 <tbody>
                   ...
                   <?php } ?>
                                 ...
                                 <h4 class="title">Prioridad Baja</h4>
                  ...
                  <?php
                    ...
                    $res=mysql_query("select * from actividades where ESTADO_ACTIVIDAD='0' AND PRIORIDAD_ACTIVIDAD='Baja' order by `FECHA_INGRESO` asc  ");
	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel"><i class='glyphicon glyphicon-edit'></i> Agregar nuevo Solicitud</h4>
		  </div>
		  <div class="modal-body">
			<form class="form-horizontal" action="lib/ingresosolicitud.php" method="post" id="guardar_cliente" name="guardar_cliente">
			<div id="resultados_ajax"></div>
                         <div class="form-group">
				<label for="nombre" class="col-sm-3 control-label">Nombre de Actividad</label>
				<div class="col-sm-8">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="descripcion" name="descripcion" required>
			  	  ...
			  	  <div class="form-group">
				<label for="area" class="col-sm-3 control-label">Area Desiganada</label>
				<div class="col-sm-8">
				 <select class="form-control" id="area" name="area" required>
					<option value="">-- Selecciona estado --</option>
					<option value="Diseño">Diseño</option>
					<option value="Sistemas y TI" selected>Sistemas y TI</option>
