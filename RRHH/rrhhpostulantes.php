    ...
    <!--   you can change the color of the sidebar using: data-color="blue | azure | green | orange | red | purple" -->
    	...
    	<div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li class="active">
                    <a href="rrhhpostulantes.php">
                        <i class="pe-7s-user"></i>
                        <p>Postulantes </p>
                    </a>
                </li>
                <li>
                    <a href="rrhhdescartados.php">
            ...
            <div class="container-fluid">
                <div class="row">
                  ...
                  <?php
                    ...
                    $res=mysql_query("select * from reg_empleados where ESTADO='1' order by ID_REG_EMPLEADOS desc");
 ...
 <tbody>
                   <tr>
                       ...
                       <td><span><?php echo $fila["TELEFONO_CEL_EMP"]; ?></span></td>
                        ...
                        <td><span><a href="mailto:<?php echo $fila["EMAIL_EMP"]; ?>" title="Enviar Mail"><?php echo $fila["EMAIL_EMP"]; ?></a></span></td>
                        <td><span><?php echo $fila["CARGO"]; ?></span></td>
                        <td><span><?php echo $fila["ESTUDIOS"]; ?></span></td>
                        <td><button onclick="mostrarmodal('<?php echo $fila['ID_REG_EMPLEADOS'];?>')" data-toggle="modal" data-target="#myModal3" class="btn btn-info" >Ver</button></td>
                        <td><a href="lib/rrhhdescartarhoja.php?id=<?php echo $fila['ID_REG_EMPLEADOS'];?>" type="button" class="btn btn-danger">Descartar</a></td>                
                   </tr>
