...
$name=$_GET['name2'];
$ingreso=$_GET['ingresol3'];
$altura=$_GET['altural'];
$pado_perimetro=$_GET['pado_perimetrol'];
$pado_planchas=$_GET['pado_planchasl'];
$pado_stud=$_GET['pado_studl'];
$pado_track=$_GET['pado_trackl'];
$pado_cla_impacto=$_GET['pado_cla_impactol'];
$pado_tor_plancha=$_GET['pado_tor_planchal'];
$pado_tor_estructura=$_GET['pado_tor_estructural'];
$pado_masilla=$_GET['pado_masillal'];
$pado_tapel=$_GET['pado_tapel'];
...
$pdf->Ln();
$pdf->Cell(55);
$pdf->Cell(60,6,utf8_decode("Perímetro: "),1,0,'L',$fill);
$pdf->Cell(20,6,$pado_perimetro,1,0,'R',$fill);
