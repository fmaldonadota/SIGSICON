            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <h4 class="title">Servicios Cerrados</h4>
                  ...
                  <?php
                    ...
                    $res=mysql_query("select * from actividades where ESTADO_ACTIVIDAD='1' order by `FECHA_INGRESO` asc  ");
 ...
 <tbody>
                   <tr>
                       ...
                       <td><span><?php echo $fila["NOM_ACTIVIDAD"]; ?></span></td>
                        ...
                        <td><a href="lib/abrircaso.php?id=<?php echo $fila['ID_ACTIVIDAD'];?>" type="button" class="btn btn-danger">Abrir Actividad</a></td>    
